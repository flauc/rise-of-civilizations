...
const ROUGH: ReadonlySet<TerrainType> = new Set<TerrainType>(["forest", "woods", "jungle", "hills", "mesa"]);
...
export function terrainDefense(t: TerrainType): number {
  ...
  if (t === "forest" || t === "woods" || t === "jungle") return 2;
  return 0;
}
...
export function moveCost(t: TerrainType): number {
  ...
  if (t === "forest" || t === "woods" || t === "jungle" || t === "hills" || t === "mesa") return 2;
  return 1;
}
