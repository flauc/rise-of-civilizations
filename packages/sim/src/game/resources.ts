...
export const RESOURCE_DEFS: Record<ResourceId, ResourceDef> = {
  ...
  silk: R({ id: "silk", type: "luxury", name: "Silk", yields: { gold: 1 }, validTerrain: ["forest", "jungle"], improvement: "plantation" }),
  spices: R({ id: "spices", type: "luxury", name: "Spices", yields: { gold: 1 }, validTerrain: ["jungle", "forest"], improvement: "plantation" }),
  dyes: R({ id: "dyes", type: "luxury", name: "Dyes", yields: { gold: 1 }, validTerrain: ["jungle", "forest"], improvement: "plantation" }),
  furs: R({ id: "furs", type: "luxury", name: "Furs", yields: { gold: 1 }, validTerrain: ["tundra", "forest"], improvement: "camp" }),
  ivory: R({ id: "ivory", type: "luxury", name: "Ivory", yields: { gold: 1 }, validTerrain: ["jungle", "forest"], improvement: "camp" }),
  ...
  cocoa: R({ id: "cocoa", type: "luxury", name: "Cocoa", yields: { gold: 1 }, validTerrain: ["jungle", "forest"], improvement: "plantation" }),
...
export function cityAmenities(state: GameState, city: City): number {
  let amenities = empireLuxuryTypes(state, city.ownerId).size;
