...
export const RESOURCE_DEFS: Record<ResourceId, ResourceDef> = {
  ...
  deer: R({
    ...
    name: "Deer",
    yields: { food: 1 },
    validTerrain: ["forest", "woods", "tundra", "taiga"],
    improvement: "camp",
  }),
  fish: R({
    id: "fish",
  ...
  bananas: R({
    ...
    name: "Bananas",
    yields: { food: 2 },
    validTerrain: ["jungle", "forest", "woods", "wetlands"],
  ...
  dyes: R({ id: "dyes", type: "luxury", name: "Dyes", yields: { gold: 1 }, validTerrain: ["jungle", "forest", "woods", "wetlands"], improvement: "plantation" }),
  furs: R({ id: "furs", type: "luxury", name: "Furs", yields: { gold: 1 }, validTerrain: ["tundra", "forest", "woods", "taiga"], improvement: "camp" }),
