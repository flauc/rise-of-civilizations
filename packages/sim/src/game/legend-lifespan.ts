...
export const LEGEND_LIFE_EXTENSIONS: Partial<Record<string, LegendLifeExtension[]>> = {
  ...
  zhuge_liang: [{ trigger: "tech_complete", turns: 2 }, { trigger: "civic_adopted", turns: 2 }],
