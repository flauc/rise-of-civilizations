...
Promotions are earned when a unit gains enough experience (XP) from combat, clearing barbarian camps, or discovering villages. Each level-up grants one unspent promotion that can be spent immediately or saved. Promotions are class-specific: a unit can only choose from the pool matching its unit class.

## Core Rules

- Units gain **1 XP per combat** they survive, plus bonus XP for kills.
- Every **10 XP per current level** is required to level up.
- Promotions are permanent and stack.
- Promotions are **tiered**. A unit unlocks tier 1 at level 2, tier 2 at level 3, and tier 3 at level 4.
- Some promotions apply only on attack, only on defense, or only in specific terrain.

## Promotion Effects Legend

| Symbol | Meaning |
|--------|---------|
| ⚔️ | Melee / ranged strength bonus |
| 🛡️ | Defense bonus |
| ❤️ | HP / healing bonus |
| 👁️ | Sight bonus |
| 🥾 | Movement bonus |
...
| ID | Name | Effect |
|----|------|--------|
| shock | Shock | ⚔️ +3 when attacking on open ground |
...
| eagle_eye | Eagle Eye | 👁️ +1 sight |
| forager | Forager | ❤️ Heals +8 HP after killing a unit or clearing a camp |
| stalwart | Stalwart | 🛡️ -4 damage taken from the first attack against it each turn |
| besieger | Besieger | 🛡️ +3 defense when adjacent to an enemy city |
| pathfinder | Pathfinder | 🥾 Roads cost no movement; hills cost 1 less |
...
| bloodlust | Bloodlust | ❤️ Heals +12 HP on kill |
| intimidation | Intimidation | Enemy units adjacent to this unit have -2 strength |

## Ranged Promotions

| ID | Name | Effect |
|----|------|--------|
| accuracy | Accuracy | 🏹 +3 ranged strength vs targets on open ground |
| barrage | Barrage | 🏹 +3 ranged strength vs targets in rough terrain |
| cover | Cover | 🛡️ +4 defense vs ranged attacks |
| medic | Medic | ❤️ Heals self +10 and adjacent allies +10 each turn |
| extended_range | Extended Range | 🏹 +1 range |
| volley | Volley | 🏹 +2 ranged strength |
| sniper | Sniper | 🏹 +4 ranged strength vs wounded units |
| logistics | Logistics | 🥾 +1 movement |
| scouting | Scouting | 👁️ +1 sight |
| camouflage | Camouflage | 🛡️ +3 defense in rough terrain |
| field_medic | Field Medic | ❤️ Adjacent allied units heal +5 extra each turn |
...
| ID | Name | Effect |
|----|------|--------|
| siege | Siege | ⚔️ +50% strength vs cities |
| accuracy | Accuracy | 🏹 +3 ranged strength vs targets on open ground |
| medic | Medic | ❤️ Heals self +10 and adjacent allies +10 each turn |
| extended_range | Extended Range | 🏹 +1 range |
| volley | Volley | 🏹 +2 ranged strength |
| city_breacher | City Breacher | ⚔️ +4 additional strength vs cities |
| heavy_caliber | Heavy Caliber | 🏹 +3 ranged strength vs units |
| entrenchment | Entrenchment | 🛡️ +4 defense if the unit did not move this turn |
| counter_battery | Counter Battery | 🏹 +4 ranged strength vs ranged/siege units |
| rapid_deployment | Rapid Deployment | 🥾 +1 movement |
| survey | Survey | 👁️ +1 sight |
| demolition | Demolition | ⚔️ +3 strength vs units in cities or forts |
...
- **Melee** promotions emphasize raw combat, city assault, and defensive lines.
- **Cavalry** promotions reward speed, flanking, and hit-and-run tactics.
